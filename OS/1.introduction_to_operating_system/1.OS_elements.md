...
**1. Saparation of Mechanism & Policy**
...
By separating them, yuo can change your scheduling algorithm (e.g., switching from First-Come-First-Served to a Multi-Level Feedback Queue) without ever touching the complex hardware-dependent context-switching code.
