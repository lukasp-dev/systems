...
One machine, one core, three programs — each thinks it runs continuously, but the OS **multiplexes** the CPU so they take turns. That is this idea in practice. See [02.what_is_virtualization.md](./02.what_is_virtualization.md).
...
- [05.figure2.5_race_demo.md](./05.figure2.5_race_demo.md)
- [06.monolithic_vs_modular_microkernel_os.md](./06.monolithic_vs_modular_microkernel_os.md)
